...
function deactivateAllCats(e) {
	let categories = e.target.closest(".categories-page").querySelectorAll('.box');
...
/* 	if(e.target.classList.contains('close-popup')) {
	...
	if(e.target.classList.contains('bgc')) {
		...
		let colCards = e.target.closest(".customization-page").querySelectorAll('.col-cards');
		let cardCustoms = e.target.closest(".customization-page").querySelectorAll('.card-bgc div');
		let identifiers = e.target.closest(".customization-page").querySelectorAll('.txt-identifier');
		let identifiers2 = e.target.closest(".customization-page").querySelectorAll('.txt-identifier2 p');
	...
	if(e.target.classList.contains('text-color')) {
		...
		let cardText = e.target.closest(".customization-page").querySelectorAll('.card-text');
		let cardTitle = e.target.closest(".customization-page").querySelectorAll('.card-title');
		let cardBgc = e.target.closest(".customization-page").querySelectorAll('.card-bgc div');
		let identifiers2 = e.target.closest(".customization-page").querySelectorAll('.txt-identifier2 p');
	...
	if(e.target.classList.contains('text-color')) {
		let columns = e.target.closest(".customization-page").querySelectorAll('.text-color');
	...
	if(e.target.classList.contains('bgc')) {
		let columns2 = e.target.closest(".customization-page").querySelectorAll('.bgc');
	...
	if(e.target.classList.contains('btn-open-recom')) {
		let recomSm = e.target.closest(".rankCreation-page").querySelector('.recom-sm');
	...
	if(e.target.classList.contains('col-fav-sm') || e.target.classList.contains('fav-sm')) {
		setTimeout(function() {
			window.scrollTo(0, 0);
		}, 100)
	...
	if(e.target.classList.contains('see-password')) {
		if(e.target.classList.contains('one')) {
			...
			} else if(document.querySelector('.input-pwd-one').type === "password") {
		...
		if(e.target.classList.contains('two')) {
			...
			} else if(document.querySelector('.input-pwd-two').type === "password") {
				e.target.src="/Images/password/icon_close.svg";
