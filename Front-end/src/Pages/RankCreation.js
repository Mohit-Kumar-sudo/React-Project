...
export default class RankCreation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      Title: props.Title,
      Ranking: props.location.ranking ? props.location.ranking : [],
  ...
  handleSubmit = () => {
    ...
    if (!_id) {
      if (!name) { 
        ...
        this.setState({error:"Please Add Some Items To the Rank"})
      }
      else {
  ...
  render() {
    return (
      <div className="rankCreation-page">
        {this.state.error.length? <div className="popup">
          <div className="popup-content">
            <button className="btn-close" onClick={()=>this.setState({error:""})}></button>
            <h4>Error!</h4>
            <h5>{this.state.error}</h5>
            <button className="btn-popup" onClick={()=>this.setState({error:""})}>
              Okay
            </button>
          </div>
        </div>:null}
          ...
          <div className="container">
            ...
            <div className="row mt-5 d-flex justify-content-center align-items-start">
              ...
              {this.state.Ranking.length ?(
                <div className="col-md-7 col-movie mt-3" onDrop={(e) => {
                    e.preventDefault()
                    ...
                    <div className="row">
                        <div className="col">
                            <h4 className="movie-title"><CssTextField color="error" label="Rank Name" value={this.state.name} onChange={(e)=>this.setState({name:e.target.value})}/>
                            </h4>
                        </div>
                    </div>
                    <CreateRank
              ...
              <div className="col-md-7 d-flex flex-column justify-content-start align-items-center col-icon-items">
                ...
                <h5 className="text-white text-center d-none d-md-block">
                  <CssTextField value={this.state.name} label="Rank Name" onChange={(e)=>this.setState({name:e.target.value})}/>
                </h5>
