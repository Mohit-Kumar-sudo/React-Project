    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.profile.profile_img) {
          this.setState({
            image: BASE_URL + "/" + response.data.profile.profile_img,
          });
        }
      })
      .catch((err) => {
    ...
    return (
      <div className="profile-page">
            ...
            >
              <div className="navbar-nav d-flex justify-content-between">
                ...
                <a className="nav-link d-none d-md-block" onClick={this.handleHome}>Home</a>
                  ...
                  <a className="nav-link" onClick={this.handleLibrary} >Library</a>
        ...
        <div className="options d-flex d-md-none justify-content-around align-items-center mb-3">
          <a className="option-link d-flex align-items-center" href="#">
          ...
          <div className="container">
            <div className="row">
              <div className="col mt-4 d-flex flex-column justify-content-center align-items-center col-image">
                ...
                <div style={{position:"relative",textAlign:"center",color:"#577A79",fontSize:20,fontWeight:"bold",borderRadius:200,overflow:"hidden"}}>
                <img
                  src={
                    !this.state.image
                  ...
                  alt=""
                />
                {!this.state.image?<div style={{position:"absolute",top:"60%", left:"20%", }}>ADD YOUR<br/> AVATAR</div>:null}
                </div>
              </div>
            </div>
            ...
            <div className="row mt-5 d-flex justify-content-center">
              <div className="col-10 col-md-8 col-lg-7 d-flex flex-column justify-content-start align-items-center">
