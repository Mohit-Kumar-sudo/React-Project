            ...
            <div class="signup2-page">
                <div className="row">
                    <div className="options d-flex d-md-none justify-content-between align-items-center col-7">
                        ...
                        <a className="option-link" href="#">Sign Up</a>
                    </div>
                </div>
                    ...
                    <div className="col-md-6 col-right row-login">
                        <div className="row mt-4">
                            <div className="col d-flex flex-column justify-content-center align-items-center">
                                <h4 className="d-block">Well done!
                                  You’ve created an account on Favvle!</h4>
                                <a href="#" className="btn-login" onClick={this.handleHome}>Continue</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-6 d-none d-md-flex flex-column col-left">
                        <nav className="navbar navbar-expand-md navbar-dark bg-transparent">
                            ...
                            <a className="navbar-brand d-flex justify-content-center" href="#">
                                <img src="Images/about/logo.png" className="img-fluid img-logo" />
                            </a>
                            </div>
                        </nav>    
                        ...
                        <ul>
                          <li>
                            <img src="Images/signup/ellipse.svg" alt=""/>Create beautiful rankings, with up to 25 items in each ranking
                          </li>
                          <li>
