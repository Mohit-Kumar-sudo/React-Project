...
export default class Customization extends React.Component {
  ...
  handleRank = () => {
    const { ranking, category, listname, backgroundcolor, textcolor, nametoggle, ranktoggle, columns,_id } = this.state;
      ...
      <div className="customization-page">
        ...
        <div className="inner-content sm d-block d-lg-block">
            ...
            <div className="row row-info">
              <div className="col d-flex justify-content-end">
                ...
                <div className="info-popup">
                  ...
                  <p>You’ve chosen a name and category for your ranking, so the next step is to add items to your list. For example, you’re making a ranking of your favorite 60’s bands: in this section you add The Turtles, The Beach Boys and The Kinks. You can do so by typing the name of the bands in the ‘Add’-field. You can add up to 25 items to your list.

                  Once you’ve added all the items you want to add, click on Continue and finalize your ranking.</p>
                </div>
              </div>
            </div>
                ...
                <div className="row d-flex flex-column justify-content-center align-items-stretch">
                  <div className="col">
                    ...
                    <div className="color-group one">
                      <a>
                        <div className="color-box bgc one active" onClick={()=>this.setState({backgroundcolor:'#298C82'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc two" onClick={()=>this.setState({backgroundcolor:'#101010'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc three" onClick={()=>this.setState({backgroundcolor:'#36454F'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc four" onClick={()=>this.setState({backgroundcolor:'#251E3E'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc five" onClick={()=>this.setState({backgroundcolor:'#FCFCFC'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc six" onClick={()=>this.setState({backgroundcolor:'#05144A'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc seven" onClick={()=>this.setState({backgroundcolor:'#183F0D'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc eight" onClick={()=>this.setState({backgroundcolor:'#73234E'})}></div>
                      </a>
                    </div>
                  </div>
                      ...
                      <div className="switch-name">
                        ...
                        <label className="switch">
                          <input
                            ...
                            defaultChecked={true}
                            onChange={() =>
                              this.setState({ nametoggle: !this.state.nametoggle })
                            }
                          />
                      ...
                      <div className="switch-rank">
                        ...
                        <label className="switch">
                          <input
                            ...
                            defaultChecked={true}
                            onChange={() =>
                              this.setState({ ranktoggle: !this.state.ranktoggle })
                            }
                          />
                          <span className="slider round"></span>
                        </label>
          ...
          <div className="d-block d-lg-none">
            ...
            <div className="row row-cards mt-5 d-flex justify-content-center align-items-center" style={{border:"solid 1px black"}}>
              <div className="col-md-12 col-cards" style={{border:"solid 1px black"}}>
                <div className="row row-movie d-flex justify-content-center flex-wrap" style={{border:"solid 1px white"}}>
                  <GetRanks
                       Ranking={this.state.ranking}
                       textcolor={this.state.textcolor}
                       ranktoggle={this.state.ranktoggle}
              ...
              <div className="col-md-3 col-txt2 d-none d-lg-block">
                <div className="row d-flex flex-column justify-content-start align-items-start">
                  ...
                  <div className="color-group">
                      <a>
                        <div className="color-box bgc one active-item" onClick={()=>this.setState({backgroundcolor:'#298C82'})}></div>
                      </a>
                      <a>
                        <div className="color-box bgc two" onClick={()=>this.setState({backgroundcolor:'#101010'})}></div>
                      </a>
                ...
                <div className="row d-flex flex-column justify-content-start align-items-start">
                  ...
                  <div className="column-group d-flex justify-content-around">
                    <div className="row col-settings">
                      ...
                      <div className={"col-4 col-choice d-flex justify-content-center" + (this.state.columns === 4 ? "active-item" : "")} >
                        <a onClick={() => this.setState({ columns: 4 })}>
                          <div className="column-box one d-flex flex-column justify-content-center align-items-center">
                            <h6>4</h6>
                            <img
              ...
              <div class="col">
                <ul class="nav nav-tabs d-flex justify-content-center" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a class="nav-link one link-tab active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Color</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link link-tab middle" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Column</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link three link-tab" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Styles</a>
                  </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                  ...
                  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row col-settings">
                      <div
                          className={"col-4 size-five col-choice d-flex justify-content-center " + (this.state.columns === 5 ? "active-item" : "") }>
                          <a onClick={() => this.setState({ columns: 5 })}>
                            <div className="column-box one d-flex flex-column justify-content-center align-items-center">
                              <h6>5</h6>
                              <img
                        ...
                        <div
                          className={"col-4 col-choice d-flex justify-content-center " + (this.state.columns == 4 ? "active-item" : "")}  onClick={() => this.setState({ columns: 4 })}>
                          <a onClick={() => {
                            this.setState({ columns: 4 })
                            }}>
                            <div className="column-box one d-flex flex-column justify-content-center align-items-center">
                              <h6>4</h6>
                              <img src="Images/customization/col-4.png" alt="..." />
                            </div>
                          </a>
                        </div>
                        <div
                          className={"col-4 col-choice d-flex justify-content-center " + (this.state.columns === 3 ? "active-item" : "")}>
                          <a onClick={() => {
                            ...
                            <div className="column-box one d-flex flex-column justify-content-center align-items-center">
                              <h6>3</h6>
                              <img src="Images/customization/col-3.png" alt="..." />
                            </div>
                          </a>
                        </div>
                    </div>
