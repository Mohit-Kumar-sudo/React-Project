...
export default class Library extends React.Component {
      ...
      .then((response) => {
        ...
        if (response.data.status) {
          ...
          if (response.data.profile) {
            this.setState({
              image: BASE_URL + "/" + response.data.profile,
            });
          }
          /* if (response.data.ranks.length > 4) this.setState({ popup: true }); */
  ...
  handleImage = (event) => {
    ...
    axios
      .post(BASE_URL + "/users/updateprofilepic", form, {
        headers: {
          authorization: `Bearer ${usertoken}`,
        },
      })
    ...
    return (
      <div className="libraryMain-page">
            ...
            >
              <div className="navbar-nav d-flex justify-content-between">
                <div className="d-flex justify-content-around align-items-center">
                  ...
                  <a className="nav-link" onClick={this.handleProfile}>Profile</a>
                </div>
                <div className="d-flex justify-content-around align-items-center">
                  <a
        ...
        <div className="options-back d-flex d-md-none justify-content-start align-items-center">
          <a href="#" className="option-lk-back">
            <img src="Images/login/arrow-icon.png" className="header-icon" />
          </a>
        </div>
          ...
          <div className="container">
            {this.state.popup && (
              <div className="popup">
                <div className="popup-content">
                  <button className="close-popup btn-close" style={{marginTop:100,marginRight:10}}  onClick={() => { this.setState ({popup:false})}}></button>
                  <h4>Create another list!</h4>
                  <h5>
                    You've reached the maximum of 5 lists<br></br>
                    for unlimited amount of lists for just $2.99 per month.<br/> Click here!
                  </h5>
                  <div className="d-flex align-items-start button-g">
                    <button className="close-popup btn-popup" style={{marginTop:-30}} onClick={this.handlePricing}>Upgrade</button>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="row">
              <div className="col mt-4 d-flex flex-column justify-content-center align-items-center col-image">
                ...
                <div style={{position:"relative",textAlign:"center",color:"#577A79",fontSize:15,fontWeight:"bold",borderRadius:200,overflow:"hidden"}}>
                <img
                  src={
                    !this.state.image
                  ...
                  alt=""
                />
                {!this.state.image?<div style={{position:"absolute",top:"60%", left:"15%", }}>ADD YOUR<br/> AVATAR</div>:null}
                </div>
              </div>
            </div>
            ...
            <div className="row mt-5">
              <div className="col d-flex flex-column justify-content-center align-items-center">
                ...
                <p className="desc-p mt-3 d-none d-md-block">
                  Welcome Eric, here in the library you can manage all your
                  rankings. Share them on social media and continue creating new
                  awesome lists.
                </p>
                <p className="desc-p mt-3 d-block d-md-none">
                  Welcome to your library Eric
                </p>
              </div>
            </div>
                ...
                <div className="row d-flex justify-content-center">
                  <div className="col">
                    <div className="tab-content" id="pills-tabContent">
                      ...
                      >
                        <div style={{display: "flex",justifyContent:"center",alignItems: "center",fontWeight:"bold" ,color:this.state.ranklist.length?(this.state.ranklist[this.state.counter].backgroundcolor==="#FCFCFC"?"black":"white"):"white"}}>{this.state.ranklist.length?this.state.ranklist[this.state.counter].name:""}</div>
