...
export default class HomePage extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
         const {text1,text2,text3,text4,test5} = this.state
        axios
        .post(
            BASE_URL+"/admin/settexts",{
                text1,text2,text3,text4,test5
            }
        )
        .then((response) => {
                        ...
                        <div className="container" style={{marginTop:80}}>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea" rows="2" onChange={this.handleText2} ></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea"> Text 3</label>
                                    <textarea class="form-control" id="exampleTextarea" rows="2" onChange={this.handleText3} ></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea"> Text 4</label>
                                    <textarea class="form-control" id="exampleTextarea" rows="2" onChange={this.handleText4} ></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea"> Text 5</label>
                                    <textarea class="form-control" id="exampleTextarea" rows="2" onChange={this.handleText5} ></textarea>
                                </div>
