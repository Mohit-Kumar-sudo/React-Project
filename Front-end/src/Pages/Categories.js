...
export default class Categories extends React.Component {
  ...
  handleContinue = () => {
    ...
    if(!category){
      this.setState({ error: "Please select a category to continue the ranking process!"})
    } else  {
      ...
      <div className="categories-page">
       {this.state.popup && <div className="popup">
          <div className="popup-content">
            <button className="btn-close" onClick={() => {this.setState ({popup:false})}}></button>
            <h4>Coming Soon!</h4>
            <h5>The category will be available a bit later</h5>
            <button href="#" className="btn-popup" onClick={() => {this.setState ({popup:false})}}>
              Okay
            </button>
          </div>
        </div>}
          ...
          <div className="container">
            ...
            <div className="row categories-box d-flex justify-content-center flex-wrap">
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box one" value="Cinema" onClick={this.handleClick}>
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box two" value="Music" onClick={this.handleClick} >
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box three" value="Sports" onClick={this.handleClick}>
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box four" value="Books" onClick={this.handleClick}>
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box five" value="Games" onClick={this.handleClick}>
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box six" value="Food" onClick={this.handleClick}>
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box seven" value="Travel" onClick={this.handleClick}>
                  <img
              ...
              <div className="col-6 col-md-3 d-flex justify-content-center">
                <button className="box lamp eight" value="Other" onClick={this.handlePopup} >
                  <img
