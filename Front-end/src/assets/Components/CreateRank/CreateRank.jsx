...
import "../../css/components/CreateRank.css";
...
export default function CreateRank({Ranking, handleRemoval, handleSorting}) {
  ...
  return (
    <div className="container-createRank d-flex align-items-start">
      ...
      { Ranking.map((value, i) => (
        <div className="col-4 col-lg-3 d-flex justify-content-center align-items-center flex-column" key={i+"1244"}>
            <div className="card" draggable="true" id={i} onDragStart={(e) => {
            ...
            onClick={()=>handleRemoval(value)}>
              ...
              <div className="card-body">
                <h5 className="card-title" style={{overflow:"hidden", padding:1, marginTop:-18}} >{value.Title.length>20?value.Title.substring(0, 22)+"...":value.Title}</h5>
              </div>
            </div>
